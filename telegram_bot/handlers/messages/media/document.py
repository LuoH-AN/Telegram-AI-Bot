...
from telegram_bot.prompt_upload import apply_prompt_upload, parse_prompt_upload_caption
from telegram_bot.handlers.common import get_log_context, preflight_media_request
from telegram_bot.handlers.messages.media.payload import build_document_payload
from telegram_bot.handlers.messages.media.prompt_upload import (
...
async def handle_document(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        from telegram_bot.handlers.messages.chat import chat
