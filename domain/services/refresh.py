...
from infrastructure.plugins.project_config.sync.user import refresh_user_state_from_db


async def ensure_user_state(user_id: int, *, force: bool = False) -> None:
    """Ensure the in-memory infrastructure.cache for *user_id* is up-to-date.
