...
class CacheManager(
    ...
    def __init__(self):
        ...
        # by infrastructure.cache/sync/session.py:load() and re-keyed to the real SERIAL value
        # in infrastructure.cache/sync/session.py:sync_new() via _rekey(). Not a stable key.
