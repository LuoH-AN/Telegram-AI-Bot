...
from infrastructure.config import DB_SYNC_INTERVAL
from infrastructure.database import get_connection
from infrastructure.database.tables import create_tables
...
def init_database(cache, load_func, sync_func) -> None:
    ...
    logger.info("Database initialized, infrastructure.cache loaded")
