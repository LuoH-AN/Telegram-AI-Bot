...
from adapters.telegram.handlers.common import get_log_context, should_respond_in_group
...
async def prepare_chat_request(
    ...
    *,
    ...
    if message is None:
        return None
    if not internal_call and (not await should_respond_in_group(update, context) or message.forward_origin):
        return None
