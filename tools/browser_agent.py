...
class BrowserAgentTool(BaseTool):
    ...
    def get_instruction(self) -> str:
        return (
            ...
            "- With HF_DATASET_USERNAME/HF_DATASET_TOKEN/HF_DATASET_NAME set, login state is restored via storage_state only.\n"
            "- Open tabs, in-memory sessions, downloads, and running browser processes are not restored after restarts.\n"
