    ...
    *,
    ...
    while True:
        full, usage, thinking_sec, finish_reason, reasoning_content, tool_calls = await stream_response(
            get_ai_client(user_id), messages, settings["model"], settings["temperature"], user_reasoning_effort,
            _noop, _noop, show_waiting=False, stream_mode="off", include_thought_prefix=False, stream_cursor=False,
